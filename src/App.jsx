...
<header className='py-7 px-9 flex items-center justify-between'>
<a className=' logo '>S</a>
<ul className='flex gap-10 items-center'>
  <li><a className='text-xl hidden'>Home</a></li>
  <li><a className='text-xl hidden'>PROJECTS</a></li>
  <li><a className='text-xl hidden'>ABOUT ME</a></li>
